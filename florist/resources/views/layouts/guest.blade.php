                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav tabs">
                        ...
                        <li class="nav-item dropdown navi-h">
                                ...
                                <a data-toggle="dropdown" href="#" id="navbardrop" class="nav-link dropdown-toggle">Flowers</a>
                      ...
                      <li class="nav-item dropdown navi-h">
                                ...
                                <a data-toggle="dropdown" href="#" id="navbardrop" class="nav-link dropdown-toggle">Gifts</a>
                                <ul class="dropdown-menu" style="border: none;">
                                    <li ><a class="dropdown-item navi-h" href="#">Home Decor</a></li>
                                    <li ><a class="dropdown-item navi-h" href="#">Personalized Gifts</a></li>
                                    <li ><a class="dropdown-item navi-h" href="#">Plants</a></li>
                                    <div class="dropdown-divider"></div>
                                    <div class="dropdown-header">Others</div>
                                </ul>
                     </li>
                     <li class="nav-item">
                            <a class= "nav-link navi-h" href="#">About Us</a>
                        </li>
                         <li class="nav-item">
                            <a class= "nav-link navi-h" href="#">Contact Us</a>
                        </li>
